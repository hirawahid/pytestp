    ...
    def dataenter(ct,ag,dn,url):
        ...
        def ag_request(agent_id, url, body, headers):
            ...
            if status >= 300:
                ...
                print("AG: " + agent_id + " " + str(r))
            else:
                print(agent_id+": "+str(r))
        ...
        acd_body = {"routingEntityDtos": [{"key": str(0), "data": {"id": 0, "name": "acd_0", "tenantId": "avaya"}}]}
        ...
        bm_body = {"routingEntityDtos": [{"key": str(1), "data": {"lobId": "1", "serviceproviderId": "1", "acdId": "0",
